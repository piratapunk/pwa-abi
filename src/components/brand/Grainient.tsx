...
type GrainientCtx = { renderer: Renderer; program: Program; mesh: Mesh }
...
interface GrainientProps {
  ...
  color3?: string
  className?: string
  /** called once, after the first frame has actually rendered to the canvas */
  onReady?: () => void
}
...
export default function Grainient({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // Free the WebGL context explicitly — browsers cap live contexts (~16),
      // and relying on GC leaks them across SPA navigations ("Context Lost").
